...
multi_data = [
    ...
    ["Harman Wide Room (Definitivo)", "+4.5 dB (Notch Q=2.0)", "+5.5 dB (Lineal)", "+2.5 dB (Efecto Holográfico)", "Control modal total en esquina y cobertura amplia en zona de vida."]
]
...
story = [
    ...
    Paragraph("2. Benchmark Multimodo: Comparativa de Respuestas en Frecuencia", h1_style),
    t_multi,
    Spacer(1, 3),
    ...
    Paragraph("<b>Conclusión Página 1:</b> El perfil Harman Wide Room Coverage logra la máxima linealidad en la zona de escucha del sofá y extiende la respuesta tonal homogénea hacia la zona de vida abierta.", callout_style),
    PageBreak(),
    ...
    Spacer(1, 2),
    Image(fig_spatial, width=17.5*cm, height=8.2*cm),
    Spacer(1, 3),

    Paragraph("4. Validación Temporal: Cascada Espectral Acumulada (Waterfall CSD)", h1_style),
    Paragraph("El decaimiento temporal en bajas frecuencias confirma la eliminación del retumbo modal de esquina a 110 Hz reduciendo el tiempo de ringing de >220 ms a <90 ms.", body_style),
    Spacer(1, 2),
    Image(fig_waterfall, width=17.5*cm, height=7.8*cm),
    PageBreak(),
